  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <UiLazyImage
            :src="`/images/history/thumbnails/${eraId}/${id}.png`"
          ...
          <div
            v-if="!isUnlocked"
            class="absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 text-center rounded-2xl"
          >
            <p class="text-white font-black text-xs drop-shadow-md">
              {{
                isAvailable ? $t("map.node.locked") : $t("map.node.drafting")
              }}
            </p>
          </div>
