  ...
  <div class="max-w-7xl mx-auto px-6 py-12">
    <div v-for="era in historyData.eras.value" :key="era.id" class="mb-20">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <div v-for="level in era.levels" :key="level.id" class="relative">
          <NuxtLink
            v-if="
              progressStore.isLessonUnlocked(
                level.lesson,
                historyData.eras.value,
              )
            "
          ...
          >
            <div class="flex flex-col h-full">
              ...
              >
                ...
                <span v-else>{{ $t("lesson_card.start") }}</span>
                <Icon
          ...
          >
            <div class="flex flex-col h-full">
              ...
              <h3 class="font-black text-text text-xl leading-tight mb-2">
                {{ level.title }}
              </h3>

              <div
                class="mt-auto pt-4 flex items-center text-sm font-bold opacity-40"
              >
                <span>{{ $t("lesson_card.locked") }}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <NuxtLink
          :to="localePath(`/quiz/mastery/${era.id}`)"
