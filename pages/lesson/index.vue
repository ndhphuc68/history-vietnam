    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-[#1A535C] opacity-75 max-w-2xl mx-auto">
          Chọn một câu chuyện lịch sử hào hùng để bắt đầu hành trình khám phá
      ...
      <div
        v-for="(periodLessons, period) in groupedLessons"
        :key="period"
        class="mb-16"
      >
        <div class="flex items-center gap-4 mb-8">
          <h2 class="text-2xl font-black text-[#FF6B6B] whitespace-nowrap">
            {{ period }}
          </h2>
      ...
      <div
        ...
        class="text-center py-20 bg-white rounded-3xl border-4 border-dashed border-gray-200"
      >
        <p class="text-2xl font-bold text-gray-400 italic">
          Đang cập nhật thêm bài học mới...
        </p>
      </div>
    </div>
  </div>
